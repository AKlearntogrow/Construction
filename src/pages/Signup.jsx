...
import { UserPlus, Mail, Lock, User, AlertCircle, Loader2, HardHat, CheckCircle } from 'lucide-react'
      ...
      <div className={`w-full max-w-md p-8 rounded-2xl shadow-xl ${
        ...
        <div className="text-center mb-8">
          ...
          <p className={`mt-2 ${darkMode ? 'text-slate-400' : 'text-slate-600'}`}>
            Start managing change orders with AI
          </p>
        </div>
        ...
        {success && (
          <div className="mb-6 p-4 rounded-lg bg-green-500/10 border border-green-500/20 flex items-center gap-3">
            ...
            <p className="text-green-500 text-sm">Account created! Redirecting...</p>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            ...
            className="w-full py-3 px-4 rounded-lg font-semibold text-white bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-6"
          >
            {loading ? (
